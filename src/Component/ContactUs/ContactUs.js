      ...
      <div className="text-gray-200 body-font relative">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <form onSubmit={submitButton} className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-3xl hover:shadow-inner shadow-2xl text-lg">
                  Submit
                </button>
              </div>
            </form>
